...
class TelugugitaSpider(scrapy.Spider):
    name = "telugugita"
    ...
    def start_requests(self):
        url = 'https://www.holy-bhagavad-gita.org/chapter/1/verse/1/te'
    ...
    def parse(self, response):
        ...
        stanza['telugu_shloka']=page.xpath("article/div/div[1]/div[1]/p").get()
        stanza['telugu_def']=response.xpath("//span[contains(@class, 'verseShort')]/following-sibling::text()[1]").get()
        yield stanza
